...
namespace Lithnet.Miiserver.Client
{
    public class StagingCounters : XmlObjectBase
    {
        ...
        public CounterDetail StageNoChangeDetail => this.GetObject<CounterDetail>("stage-no-change",  new object[] { this.stepID });
        ...
        public CounterDetail StageAddDetail => this.GetObject<CounterDetail>("stage-add",  new object[] { this.stepID });
        ...
        public CounterDetail StageUpdateDetail => this.GetObject<CounterDetail>("stage-update",  new object[] { this.stepID });
        ...
        public CounterDetail StageRenameDetail => this.GetObject<CounterDetail>("stage-rename",  new object[] { this.stepID });
        ...
        public CounterDetail StageDeleteDetail => this.GetObject<CounterDetail>("stage-delete",  new object[] { this.stepID });
        ...
        public CounterDetail StageDeleteAddDetail => this.GetObject<CounterDetail>("stage-delete-add",  new object[] { this.stepID });
        ...
        public CounterDetail StageFailureDetail => this.GetObject<CounterDetail>("stage-failure",  new object[] { this.stepID });
