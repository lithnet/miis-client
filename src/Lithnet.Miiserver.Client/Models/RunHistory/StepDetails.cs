...
namespace Lithnet.Miiserver.Client
{
    public class StepDetails : XmlObjectBase
    {
        ...
        /// </summary>
        public RunStep StepDefinition => this.GetObject<RunStep>("step-description");
        ...
        /// </summary>
        public MADiscoveryCounters MADiscoveryCounters => this.GetObject<MADiscoveryCounters>("ma-discovery-counters");
        ...
        /// </summary>
        public IReadOnlyList<OutboundFlowCounters> OutboundFlowCounters => this.GetReadOnlyObjectList<OutboundFlowCounters>("outbound-flow-counters");
        ...
        /// </summary>
        public StagingCounters StagingCounters => this.GetObject<StagingCounters>("staging-counters");
        ...
        /// </summary>
        public InboundFlowCounters InboundFlowCounters => this.GetObject<InboundFlowCounters>("inbound-flow-counters");

        /// <summary>
        /// Gets statistics on the number of changes that are sent out. If the step type is export, this element is present.
        /// </summary>
        public ExportCounters ExportCounters => this.GetObject<ExportCounters>("export-counters");
        ...
        /// </summary>
        public string StepID => this.GetValue<string>("step-id");
    }
}
